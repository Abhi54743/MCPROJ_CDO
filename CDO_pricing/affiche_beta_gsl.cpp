...
struct beta_density {
    beta_density(double a, double b) 
        : _alpha(a), _beta(b), _cst(gsl_sf_beta(a,b)) {}
...
void affiche_beta_ziggurat(double alpha, double beta, unsigned n) {
...
int main() {  
    affiche_beta_ziggurat(2, 2, 8);  
    affiche_beta_ziggurat(2, 2, 32);  
    affiche_beta_ziggurat(2, 2, 256);  
    
    affiche_beta_ziggurat(1.5, 2.5, 8);  
    affiche_beta_ziggurat(1.5, 2.5, 32);  
    affiche_beta_ziggurat(1.5, 2.5, 256);  
